module LoremIpsum (loremIpsum) where
...
loremIpsum =
  ...
  \nec nonummy molestie, enim est eleifend mi, non fermentum diam nisl \
  \sit amet erat. Duis semper. Duis arcu massa, scelerisque vitae, \
  \consequat in, pretium a, enim. Pellentesque congue. Ut in risus \
  \volutpat libero pharetra tempor. Cras vestibulum bibendum \
  \augue. Praesent egestas leo in pede. Praesent blandit odio eu \
  \enim. Pellentesque sed dui ut augue blandit sodales. Vestibulum ante \
  ...
  \tincidunt tincidunt mi. Curabitur iaculis, lorem vel rhoncus faucibus, \
  \felis magna fermentum augue, et ultricies lacus lorem varius \
